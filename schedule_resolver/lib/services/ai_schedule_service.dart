  ...
  Future<void> analyzeSchedule(List<TaskModel> task) async {
    ...
    try {
      ...
      final prompt = '''
           ...
           Provide a revised daily timeline view adjusting the task to resolve conflicts and balance the student's workload, study time , and rest.
           4. ### Explanation
           Explain why this recommendation was made in simple language that a student easily understand          
